...
bool Parser::statement(void) {
  ...
  // Add Code here
    ...
    if ( (current_word.get_token_type() == TokenType::IDENTIFIER)  ) {
      ...
      if ( (current_word.get_token_type() == TokenType::STRING ) && (current_word.get_token_name() == "if") ){
        if(get_next_word()){
          if ( (current_word.get_token_type() == TokenType::SYMBOL ) && (current_word.get_token_name() == "(") ){
            if(get_next_word()){
...
//                                | while left_parenthesis <condition_expression> right_parenthesis <block_statements>                     FIRST_PLUS = { while }
      ...
      if ( (current_word.get_token_type() == TokenType::STRING ) && (current_word.get_token_name() == "while") ){
        if(get_next_word()){
          if ( (current_word.get_token_type() == TokenType::SYMBOL ) && (current_word.get_token_name() == "(") ){
            if(get_next_word()){
              if(condition_expression()){
        ...
        if ( (current_word.get_token_type() == TokenType::STRING ) && (current_word.get_token_name() == "return") ){
          if(get_next_word()){
            if(statement_2()){
              return(true);
            }
  ...
  //                                | break semicolon                     FIRST_PLUS = { break }
    ...
    if ( (current_word.get_token_type() == TokenType::STRING ) && (current_word.get_token_name() == "break") ){
      if(get_next_word()){
        if ( (current_word.get_token_type() == TokenType::SYMBOL ) && (current_word.get_token_name() == ";") ){
          if(get_next_word()){
            return (true);
    ...
    if ( (current_word.get_token_type() == TokenType::STRING ) && (current_word.get_token_name() == "continue") ){
      if(get_next_word()){
        if ( (current_word.get_token_type() == TokenType::SYMBOL ) && (current_word.get_token_name() == ";") ){
          if(get_next_word()){
            return (true);
    ...
    //                                | read left_parenthesis ID right_parenthesis semicolon                     FIRST_PLUS = { read }
  else if ( (current_word.get_token_type() == TokenType::STRING ) && (current_word.get_token_name() == "read") ){
      if(get_next_word()){
        if ( (current_word.get_token_type() == TokenType::SYMBOL ) && (current_word.get_token_name() == "(") ){
          if(get_next_word()){
            if ( (current_word.get_token_type() == TokenType::IDENTIFIER)  ){
    ...
    //                                | write left_parenthesis <expression> right_parenthesis semicolon                     FIRST_PLUS = { write }
  else if ( (current_word.get_token_type() == TokenType::STRING ) && (current_word.get_token_name() == "write") ){
    if(get_next_word()){
      if((current_word.get_token_type() == TokenType::SYMBOL ) && (current_word.get_token_name() == "(")){
        if(get_next_word()){
          if(expression()){
  ...
  }else if ((current_word.get_token_type() == TokenType::STRING ) && (current_word.get_token_name() == "print"))
  {
    if(get_next_word()){
      if((current_word.get_token_type() == TokenType::SYMBOL ) && (current_word.get_token_name() == "(")){
        if(get_next_word()){
          if ((current_word.get_token_type() == TokenType::STRING ) && (current_word.get_token_name() == "STRING")){
            if(get_next_word()){
              if((current_word.get_token_type() == TokenType::SYMBOL ) && (current_word.get_token_name() == ")")){
                if(get_next_word()){
                  if((current_word.get_token_type() == TokenType::SYMBOL ) && (current_word.get_token_name() == ";")){
